...
void CalculateAllHistoryStats() {
  ...
  Print("=== History Stats Calculated ===");
  Print("Net Deposit: ", netDeposit);
  Print("Total Trades: ", totalTrades);
  Print("Win Rate: ", (totalTrades > 0 ? (winTrades * 100.0 / totalTrades) : 0), "%");
  Print("Max DD: ", maxDrawdownAmount, " (", maxDrawdownPercent, "%)");
}
